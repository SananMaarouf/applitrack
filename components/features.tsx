                    ...
                    <div className="
                        ...
                        {features.map((_, index) => (
                            <button
                                ...
                                className={`
																	py-3 lg:py-0 w-full lg:w-16 h-full flex items-center justify-center text-sm font-semibold transition-colors
																	duration-300 rounded-t-xl border-b-2 lg:border-b-0 lg:rounded-t-none lg:rounded-l-xl lg:border-r-2
																	${

...
function Sidebar({
  ...
  const usesInsetPadding = side === "right" && variant === "inset"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative bg-transparent transition-[width] duration-300 ease-linear",
          usesInsetPadding
            ? "w-0 group-data-[collapsible=offcanvas]:w-0 group-data-[collapsible=icon]:w-0"
            : [
                "w-(--sidebar-width)",
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="secondary"
      size={"icon-lg"}
      className={cn("size-12 bg-primary text-primary-foreground hover:bg-primary/90", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "relative flex w-full flex-1 flex-col overflow-hidden bg-background transition-[margin,padding-left,padding-right,border-radius,box-shadow] duration-300 ease-linear",
        ...
        "md:peer-data-[variant=inset]:peer-data-[side=right]:mr-2",
        "md:peer-data-[variant=inset]:peer-data-[side=right]:pr-(--sidebar-width)",
        "md:peer-data-[variant=inset]:peer-data-[side=right]:peer-data-[collapsible=icon]:pr-[calc(var(--sidebar-width-icon)+1rem)]",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-[calc(var(--sidebar-width-icon)-1rem)]! group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 group-data-[collapsible=icon]:[&>span]:hidden group-data-[collapsible=icon]:[&>svg]:size-5",
  {
    variants: {
      variant: {
